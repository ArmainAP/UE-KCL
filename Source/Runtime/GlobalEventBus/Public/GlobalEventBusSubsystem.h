...
DECLARE_DYNAMIC_DELEGATE_TwoParams(FGlobalEventPayload, const UEventBusDataAsset*, Event, const UObject*, Payload);
...
public:
	...
	static bool RegisterGlobalEventAsset(const UObject* WorldContextObject, const UEventBusDataAsset* Asset, const FGlobalEvent& Callback);

	UFUNCTION(BlueprintCallable, Category = "Global Event Bus", meta = (WorldContext = "WorldContextObject"))
	static bool RegisterGlobalEventID(const UObject* WorldContextObject, const FString& ID, const FGlobalEvent& Callback);

	UFUNCTION(BlueprintCallable, Category = "Global Event Bus", meta = (WorldContext = "WorldContextObject"))
	static bool RegisterGlobalPayloadEventAsset(const UObject* WorldContextObject, const UEventBusDataAsset* Asset, const FGlobalEventPayload& Callback);
	...
	UFUNCTION(BlueprintCallable, Category = "Global Event Bus", meta = (WorldContext = "WorldContextObject"))
	static bool UnregisterGlobalEvent(const UObject* WorldContextObject, const UEventBusDataAsset* Asset);
	...
	UFUNCTION(BlueprintCallable, Category = "Global Event Bus", meta = (WorldContext = "WorldContextObject"))
	static bool InvokeGlobalEventAsset(const UObject* WorldContextObject, const UEventBusDataAsset* Asset);

	UFUNCTION(BlueprintCallable, Category = "Global Event Bus", meta = (WorldContext = "WorldContextObject"))
	static bool InvokeGlobalEventID(const UObject* WorldContextObject, const FString& ID);

	UFUNCTION(BlueprintCallable, Category = "Global Event Bus", meta = (WorldContext = "WorldContextObject"))
	static bool InvokeGlobalPayloadEventAsset(const UObject* WorldContextObject, const UEventBusDataAsset* Asset, const UObject* Payload);
...
protected:
	UPROPERTY()
	TMap<FString, const UEventBusDataAsset*> GlobalEventAssets;
